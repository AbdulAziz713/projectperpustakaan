...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pustakawan.books.index')->with('success', 'Buku berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, Book $book)
    {
        ...
        return redirect()->route('pustakawan.books.index')->with('success', 'Buku berhasil diperbarui.');
    }
