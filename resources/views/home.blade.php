...
@section('content')
        ...
        <section id="hero" class="hero section">
            ...
            <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div class="carousel-item active">
                    <img src="{{ asset('assets/slide1.jpg') }}" alt="">
                    <div class="container">
                    @if (auth()->user()->role ==='petugas')
                      ...
                      <h2>Selamat Datang Admin Daerah</h2>
                    @endif
                ...
                <div class="carousel-item">
                    <img src="{{ asset('assets/slide2.jpg') }}" alt="">
                    <div class="container">
        ...
        <section id="features" class="features section">
            ...
            <div class="container">
                ...
                <div class="row justify-content-around gy-4">
                    <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100"><img src="{{ asset('MediCio-1.0.0/assets/img/features.jpg') }}" alt=""></div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tabs-tab-1">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('MediCio-1.0.0/assets/img/departments-1.jpg') }}" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('MediCio-1.0.0/assets/img/departments-2.jpg') }}" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('MediCio-1.0.0/assets/img/departments-3.jpg') }}" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('MediCio-1.0.0/assets/img/departments-4.jpg') }}" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-tab-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('MediCio-1.0.0/assets/img/departments-5.jpg') }}" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="testimonials" class="testimonials section">
            ...
            <p>
              <i class=" bi bi-quote quote-icon-left "></i>
                ...
                <img src="{{ asset('MediCio-1.0.0/assets/img/testimonials/testimonials-1.jpg') }}" class="testimonial-img " alt=" ">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
              </div>
            ...
            <div class="swiper-slide ">
              <div class="testimonial-item ">
                ...
                <img src="{{ asset('MediCio-1.0.0/assets/img/testimonials/testimonials-2.jpg') }}" class="testimonial-img " alt=" ">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide ">
              <div class="testimonial-item ">
                ...
                <img src="{{ asset('MediCio-1.0.0/assets/img/testimonials/testimonials-3.jpg') }}" class="testimonial-img " alt=" ">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide ">
              <div class="testimonial-item ">
                ...
                <img src="{{ asset('MediCio-1.0.0/assets/img/testimonials/testimonials-4.jpg') }}" class="testimonial-img " alt=" ">
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide ">
              <div class="testimonial-item ">
                ...
                <img src="{{ asset('MediCio-1.0.0/assets/img/testimonials/testimonials-5.jpg') }}" class="testimonial-img " alt=" ">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
              </div>
            </div><!-- End testimonial item -->
      ...
      <div class="container ">
        ...
        <div class="row gy-4 ">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch " data-aos="fade-up " data-aos-delay="100 ">
            <div class="team-member ">
              <div class="member-img ">
                <img src="{{ asset('MediCio-1.0.0/assets/img/doctors/doctors-1.jpg') }}" class="img-fluid " alt=" ">
                <div class="social ">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch " data-aos="fade-up " data-aos-delay="200 ">
            <div class="team-member ">
              <div class="member-img ">
                <img src="{{ asset('MediCio-1.0.0/assets/img/doctors/doctors-2.jpg') }}" class="img-fluid " alt=" ">
                <div class="social ">
                  <a href=" "><i class="bi bi-twitter-x "></i></a>
                  <a href=" "><i class="bi bi-facebook "></i></a>
                  <a href=" "><i class="bi bi-instagram "></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch " data-aos="fade-up " data-aos-delay="300 ">
            <div class="team-member ">
              <div class="member-img ">
                <img src="{{ asset('MediCio-1.0.0/assets/img/doctors/doctors-3.jpg') }}" class="img-fluid " alt=" ">
                <div class="social ">
                  <a href=" "><i class="bi bi-twitter-x "></i></a>
                  <a href=" "><i class="bi bi-facebook "></i></a>
                  <a href=" "><i class="bi bi-instagram "></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch " data-aos="fade-up " data-aos-delay="400 ">
            <div class="team-member ">
              <div class="member-img ">
                <img src="{{ asset('MediCio-1.0.0/assets/img/doctors/doctors-4.jpg') }}" class="img-fluid " alt=" ">
                <div class="social ">
                  <a href=" "><i class="bi bi-twitter-x "></i></a>
                  <a href=" "><i class="bi bi-facebook "></i></a>
                  <a href=" "><i class="bi bi-instagram "></i></a>
    ...
    <section id="contact " class="contact section ">
      ...
      <div class="mb-5 " data-aos="fade-up " data-aos-delay="200 ">
        <iframe style="border:0; width: 100%; height: 370px; " src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.5848521231974!2d107.75480077591786!3d-6.573961764265904!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e693d005c8004d5%3A0x65b2eba983ad55c5!2sPerpustakaan%20Daerah%20Kabupaten%20Subang!5e0!3m2!1sid!2sid!4v1748188025492!5m2!1sid!2sid"
