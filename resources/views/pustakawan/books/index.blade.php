...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('pustakawan.books.create') }}" class="btn btn-primary">+ Tambah Buku</a>
    </div>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $book->stock }}</td>
                            <td>
                                <a href="{{ route('pustakawan.books.edit', $book) }}" class="btn btn-sm btn-info text-white">Edit</a>
                                <form action="{{ route('pustakawan.books.destroy', $book) }}" method="POST" class="d-inline delete-form">
                                    @csrf @method('DELETE')
